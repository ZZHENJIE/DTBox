...
impl UserRepository {
    ...
    /// Create new user
    pub async fn create(&self, username: &str, password_hash: &str) -> Result<user::Model> {
    ...
    pub async fn update_permissions(&self, id: i32, permissions: i32) -> Result<()> {
        ...
        tracing::info!(
            "User permissions updated: id={}, permissions={}",
            id,
            permissions
        );
